...
import IngestionPanel from "@/components/vedcode/IngestionPanel";
import RippleGuard from "@/components/vedcode/RippleGuard";
import DocumentReader from "@/components/vedcode/DocumentReader";
import ConceptGalaxy from "@/components/vedcode/ConceptGalaxy";
...
export default function VedCodePage() {
  // Persist active tab across navigations
  const [tab, setTab] = useLocalStorage<Tab>("vedcode_active_tab", "ingest");

  return (
    <div className="flex-1 h-full bg-[#020617] flex flex-col overflow-hidden text-slate-100 font-sans selection:bg-blue-500/20">

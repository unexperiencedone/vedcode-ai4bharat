      ...
      <div className="flex w-full">
        ...
        <div className="z-10 flex w-full flex-col justify-between p-8 lg:w-1/2 xl:p-16">
          ...
          <header className="flex items-center gap-3">
            ...
            <h2 className="text-xl font-bold tracking-[0.2em] text-white">THE ARCHIVE</h2>
          </header>
          ...
          <div className="mx-auto flex w-full max-w-md flex-col justify-center py-12">
            ...
            <form className="space-y-6" onSubmit={(e) => e.preventDefault()}>
              ...
              <div className="space-y-2">
                <div className="flex justify-between items-center">
                  <label className="text-sm font-semibold tracking-wider text-[#e2e2e2]/80 uppercase" htmlFor="password">
                    Password
                  </label>
            ...
            <div className="grid grid-cols-2 gap-4">
              ...
              >
                <svg className="h-5 w-5 text-[#e2e2e2] group-hover:text-white" fill="currentColor" viewBox="0 0 24 24">
          ...
          <footer className="flex items-center justify-between text-xs font-medium text-[#e2e2e2]/40">
            ...
            <div className="flex gap-4">
              <Link href="/register" className="hover:text-primary transition-colors">Request Access</Link>
              <span className="text-white/10">|</span>
              <Link href="/manifesto" className="hover:text-primary transition-colors">Documentation</Link>
            </div>
          </footer>
        </div>
        ...
        <div className="relative hidden h-screen w-1/2 lg:block">
          {/* Abstract Background */}
          <div className="h-full w-full bg-gradient-to-br from-[#0a0a0a] via-[#111318] to-[#0d46f2]/20" />
